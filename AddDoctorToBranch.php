...
<html>
    ...
    <body style="background-image: url(Images/long1.jpg);height: 1100px;">
        <ul>
            ...
            <center>
            <h1>ASSIGN DOCTOR TO A Branch</h1><hr>
            <form method="post" action="AddDoctorToBranch.php"> 
		    ...
		    <label style="font-size:20px ;font-family:cursive">Branch:</label>
		    <select id="Branch-list" name="cid">
        ...
        if(isset($_POST['submit']))
        {
		    ...
		    foreach($_POST['daylist'] as $daylist)
		    {
				...
				if (mysqli_query($conn, $sql)) 
				{
                    ...
                    // header("Refresh:3;url=AddDoctorToBranch.php");
                    echo "<script>
                        swal({ 
                            ...
                            function(){
                              window.location.href = 'AddDoctorToBranch.php';
                              });
                              </script>";
				} 
				else
